...
def home():
    ...
    return(
        ...
        f"List of routes available:<br/>"
        f"<br/>"  
        f"Precipitation & Dates:<br/>"
        f"/api/v1.0/precipitation<br/>"
        f"<br/>"
        f"Stations & names:<br/>"
        f"/api/v1.0/stations<br/>"
        f"<br/>"
        f"Temperature observations one year from the last data point:<br/>"
        f"/api/v1.0/tobs<br/>"
        f"<br/>"
        f"Min, Max, and Avg. temperatures for a given start date: (use 'yyyy-mm-dd' format):<br/>"
        f"/api/v1.0/min_max_avg/&lt;start date&gt;<br/>"
        f"<br/>"
        f"Min. Max, and Avg. temperatures for a given start and end date: (please use 'yyyy-mm-dd'/'yyyy-mm-dd' format for start and end values):<br/>"
...
def precipitation():
    ...
    # Query precipitation & date values 
...
def stations():
    ...
    # Convert list of tuples into list of dictionaries for every station&name
    station_list = []
    for result in results:
        r = {}
        r["station"]= result[0]
...
def start(start):
    ...
    # take & convert any date to yyyy-mm-dd (for qry)
...
def start_end(start, end):
    ...
    # Convert formats for start and end dates to yyyy-mm-dd (for the query)
    start_dt = dt.datetime.strptime(start, '%Y-%m-%d')
